...
const [featuredProperties, setFeaturedProperties] = useState([
    {
        ...
        baths: 3,
        sqft: 2500,
        description: "Stunning waterfront property with private beach access and panoramic ocean views. Recently renovated with smart home features.",
        amenities: ["Pool", "Gym", "Parking", "Smart Home"],
        location: "Miami, FL",
    ...
    <div className="min-h-screen bg-gray-50">
                                    ...
                                    <div className="flex justify-between items-start">
                                        ...
                                        <div className="flex space-x-2">
                                            ...
                                            <div className="relative">
                                                ...
                                                {showShareTooltip && (
                                                    <div className="absolute top-full right-0 mt-1 bg-gray-800 text-white text-xs px-2 py-1 rounded"> Link copied! </div>
                                                )}
                                            </div>
                                        </div>
                                    </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto">
                {/*Modal Header */}
                <div  iv className="sticky top-0 bg-white p-4 border-b flex justify-between items-center">
